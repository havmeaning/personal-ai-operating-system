...
- [Worked example](../examples/WORKED_EXAMPLE_001.md)
- [Limitations](LIMITATIONS.md)

## Core Method

- [Architecture](ARCHITECTURE.md)
- [Operating loop](OPERATING_LOOP.md)
- [Operational phases](OPERATIONAL_PHASES.md)
- [Report system](REPORT_SYSTEM.md)
- [Evidence method](EVIDENCE_METHOD.md)
...
- [Validation protocol](../validation/VALIDATION_PROTOCOL.md)
- [Pilot 001 protocol](../validation/PILOT_001_PROTOCOL.md)
...
The full mission, field, and after-action source archive is intentionally not published in this public repository because privacy review found protected personal material.
